...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="rg40xx-game-presence")
    ...
    prepare.add_argument("--state-dir", default="/var/lib/rg40xx-game-presence-probe")
    ...
    verify.add_argument("--state-dir", default="/var/lib/rg40xx-game-presence-probe")
    verify.add_argument("--output", default="/mnt/mmc/rg40xx-game-presence-phase0-v0.1.0.json")
    ...
    validate.add_argument(
        "--output",
        type=Path,
        default=Path("/mnt/mmc/rg40xx-game-presence-validation-v0.6.8.json"),
    )
