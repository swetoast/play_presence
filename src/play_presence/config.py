...
@dataclass(frozen=True)
class MqttConfig:
    host:str='10.0.0.5'; port:int=1883; username:str='rg40xxv'; password_file:Path=Path('/etc/play-presence/mqtt-password'); client_id:str='rg40xxv-game-presence'; topic_prefix:str='rg40xxv'; keepalive_seconds:int=60
    @property
...
def load_config(path,check_password_file=False):
    ...
    pw=_abs(m.get('password_file','/etc/play-presence/mqtt-password'),'mqtt.password_file')
